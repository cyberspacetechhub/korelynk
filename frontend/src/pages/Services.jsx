  ...
  return (
    <div className="min-h-screen bg-midnight">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              <div key={service.id} className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                <div className="p-8">
                  ...
                  <h3 className="text-2xl font-bold font-display text-white mb-4">{service.title}</h3>
                  ...
                  <div className="text-2xl font-bold text-white mb-4">From ${service.startingPrice.toLocaleString()}</div>
      ...
      <section className="py-20 bg-white/5">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-display text-white mb-4">Transparent Pricing</h2>
            <p className="text-xl text-gray-400">Choose the plan that fits your needs</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan) => (
              <div key={plan.id} className={`bg-white/5 backdrop-blur-sm border rounded-2xl p-8 ${plan.popular ? 'border-electric-cyan scale-105' : 'border-white/10'} hover:bg-white/10 transition-all`}>
                ...
                <button className={`w-full py-3 rounded-lg font-semibold transition-all ${plan.popular ? 'bg-gradient-electric text-white hover:shadow-lg hover:shadow-electric-blue/50' : 'bg-white/10 text-white hover:bg-white/20'}`}>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold font-display text-white mb-4">Our Process</h2>
            <p className="text-xl text-gray-400">How we bring your project to life</p>
          </div>
